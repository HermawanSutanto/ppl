                    ...
                    <div class="left-text-content">
                        ...
                        <div>
                            <ul style="margin-bottom:60px;">
                                <?php foreach ($tabel1 as $row) : ?>
                                    <?php foreach ($row as $satuan) : ?>
                                        ...
                                        <table style="margin-top:-10px;width:600px;text-transform: capitalize;">
                                            ...
                                            <?php else : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td <?php if ($satuan === 'Aktif') : ?> style="color:#e3b04b;" <?php endif; ?>>
                            ...
                            <a href="ubah<?= $tabel; ?>.php?id=<?= $row["id"];
                                                                ?>&username=<?= $username ?>&tabel=<?= $tabel ?>"></a>
                        </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                        <div class="left-text-content">
                            <div class="section-heading">
                                ...
                                <ul>
                                    <li>
                                        <h4 style="color:white;"> -Dapat mengakses modul</h4>
                                    </li>
                                    <li>
                                        <h4 style="color:white;"> -Informasi lengkap modul terbaru dan lengkap</h4>
                                    </li>
                                    <li>
                                        <h4 style="color:white;"> -Menerapkan hasil penelitian dan dapatkan keberhasilan</h4>
                                    </li>
                                </ul>
